...
export const websiteConfig = {
  ...
  site: {
    title: "",
    description: "欢迎来到花漫時雨，探索无限可能的方块世界！",
    ...
    items: [
      {
        ...
        pageTitle: {
          // 主标题配置（支持打字机效果）
          mainTitle: {
            texts: ["欢迎来到 花漫時雨", "Welcome to 花漫時雨"], // 多语言标题数组
            typewriter: {
